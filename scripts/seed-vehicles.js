import 'dotenv/config'; // Loads .env config
import mongoose from 'mongoose';
import { Vehicle } from './server/models/schema.js'; // Adjust to your compiled JS output directory if not directly in server/
import connectDB from './server/db.js'; // Adjust path to your db connection
...
const vehiclesToSeed = [
  {
    ...
    imageUrl: '/placeholder-limo-sprinter.jpg', // Placeholder image URL
  ...
  },
  {
    ...
    imageUrl: '/placeholder-exec-sprinter.jpg', // Placeholder image URL
