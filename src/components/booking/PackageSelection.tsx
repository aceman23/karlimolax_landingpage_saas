        ...
        {packages.map((pkg) => (
          <div 
            ...
            className={`
              ...
              ${selectedPackage?._id === pkg._id ? 'border-cyan-600 bg-cyan-50' : 'border-gray-200 hover:border-cyan-300'}
            `}
              ...
              <button
                ...
                className={`
                  ...
                  ${selectedAirport === airport.code 
                    ...
                    : 'bg-white border border-gray-200 hover:border-cyan-300 text-gray-700'}
                `}
              >
                {airport.code}
