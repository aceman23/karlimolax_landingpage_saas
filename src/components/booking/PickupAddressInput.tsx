...
const PickupAddressInput: React.FC<PickupAddressInputProps> = ({ value, onChange }) => {
  ...
  useEffect(() => {
    ...
    // Create a new instance of Autocomplete specifically for pickup
  ...
  return (
    <div className="w-full">
      <label htmlFor="pickup-address" className="block font-semibold mb-1">
        Pickup Address *
      </label>
      <input
        ref={inputRef}
