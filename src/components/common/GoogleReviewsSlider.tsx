      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center items-center gap-1">
            {[...Array(5)].map((_, i) => (
              <Star key={i} className={`h-5 w-5 ${i < Math.round(averageRating) ? 'text-cyan-500 fill-current' : 'text-gray-300'}`} />
            ))}
                          ...
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                className={`h-4 w-4 ${
                                  i < review.rating ? 'text-cyan-500 fill-current' : 'text-gray-300'
                                }`}
                              />
                            ))}
                          </div>
