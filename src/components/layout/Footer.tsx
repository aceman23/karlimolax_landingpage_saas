    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4">
              <span className="text-xl font-bold">DapperLimoLax.com</span>
            </div>
          ...
          <div className="md:ml-8">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/vehicles" className="text-gray-400 hover:text-cyan-400 transition">
                  Our Fleet
                </Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">
                  Book Now
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">LAX Airport Transfers</Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">Disneyland Shuttles</Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">Corporate Events</Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">Wedding Transportation</Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-400 hover:text-cyan-400 transition">Wine Tasting Tours</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                <Phone size={20} className="text-cyan-500 flex-shrink-0" />
              ...
              <li className="flex items-center space-x-3 mt-4">
                <Lock size={20} className="text-cyan-500 flex-shrink-0" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} DapperLimoLax. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <Link to="/login" className="text-gray-500 text-sm hover:text-cyan-400 transition flex items-center">
        ...
        <div className="mt-6 pt-6 border-t border-gray-800 text-center">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-500 text-sm hover:text-cyan-400 transition"
          >
