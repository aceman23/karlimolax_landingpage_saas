      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:bg-gray-100 disabled:cursor-not-allowed ${
        ...
        <div className="bg-cyan-50 border border-cyan-200 rounded-md p-4 mb-6">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-cyan-800">Secure Payment Processing</h3>
              <div className="mt-2 text-sm text-cyan-700">
                ...
                <p className="mt-1 text-xs text-cyan-600">If payment processing is unavailable, your booking will be completed and we'll contact you to arrange payment.</p>
              </div>
            </div>
          </div>
        </div>
