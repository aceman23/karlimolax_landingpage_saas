      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
        ...
        <div>
          ...
          <div className={`w-full px-4 py-3 border border-gray-300 rounded-md focus-within:ring-2 focus-within:ring-cyan-500 ${isProcessing ? 'opacity-50' : ''}`}>
            <CardNumberElement
              options={{
                ...elementOptions,
                disabled: isProcessing,
