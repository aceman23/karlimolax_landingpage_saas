      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-4 inline-block">
              <p className="text-sm text-gray-600 mb-1">Booking Reference</p>
              <div className="flex items-center gap-2">
                <p className="font-mono text-lg font-semibold text-cyan-700">{bookingId}</p>
                <button
                  onClick={() => {
          ...
          <div className="border-t border-b border-gray-200 py-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start">
                <Calendar className="h-5 w-5 text-cyan-500 mr-2 flex-shrink-0 mt-0.5" />
                <div>
              ...
              {currentBooking.hours && (
                <div className="flex items-start">
                  <Clock className="h-5 w-5 text-cyan-500 mr-2 flex-shrink-0 mt-0.5" />
                  <div>
              ...
              {currentBooking.packageId === 'lax-special' && currentBooking.airportCode && (
                <div className="flex items-start">
                  <MapPin className="h-5 w-5 text-cyan-500 mr-2 flex-shrink-0 mt-0.5" />
                  <div>
