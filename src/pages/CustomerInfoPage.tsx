...
export default function CustomerInfoPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12">
      <Helmet>
        <title>Customer Information | Dapper Limo LAX</title>
        <meta name="description" content="Complete your booking information for DapperLimoLax premium transportation services in Los Angeles." />
