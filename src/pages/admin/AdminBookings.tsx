            ...
            <div className="flex gap-4">
              <div>
                <select
                  ...
                  className="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm rounded-md"
                >
              ...
              {filteredBookings.map((booking) => (
                <tr key={booking._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    />
                    <button
                      className="ml-2 text-cyan-600 hover:text-cyan-900 text-sm font-medium"
                      onClick={() => {
                        setSelectedBooking(booking);
