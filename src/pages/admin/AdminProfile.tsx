...
export default function AdminProfilePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <Helmet>
        <title>Admin Profile | Dapper Limo LAX</title>
      </Helmet>
        ...
        <div className="border-t border-gray-200 px-6 py-8">
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4 max-w-md">
            ...
            <div>
              ...
              <input type="password" id="newPassword" name="newPassword" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm" placeholder="Min. 6 chars" required />
            </div>
            <div>
              <label htmlFor="confirmNewPassword" className="block text-sm font-medium text-gray-700 mb-1">Confirm New Password</label>
              <input type="password" id="confirmNewPassword" name="confirmNewPassword" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm" placeholder="Confirm password" required />
            </div>
