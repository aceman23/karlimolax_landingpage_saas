                ...
                <tr key={user._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <select
                      ...
                      className={`block w-full pl-3 pr-10 py-2 text-xs border-gray-300 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 rounded-md ${getRoleBadgeColor(user.role || '')}`}
                    >
